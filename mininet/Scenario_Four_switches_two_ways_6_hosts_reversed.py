...
def four_switches_network():
    ...
    info('*** Add links\n')
    linkArray.append(net.addLink(s1, s2, delay='14ms',use_tbf = True, bw=3, max_queue_size=queue_lenght))
    linkArray.append(net.addLink(s2, s4, delay='14ms',use_tbf = True, bw=3, max_queue_size=queue_lenght))
    linkArray.append(net.addLink(s1, s3, delay='10ms',use_tbf = True, bw=4, max_queue_size=queue_lenght))
    linkArray.append(net.addLink(s3, s4, delay='10ms',use_tbf = True, bw=4, max_queue_size=queue_lenght))
